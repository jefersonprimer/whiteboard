          ...
          {extraTools.map((option) => {
            ...
            return (
              <button
                ...
                className={`flex items-center justify-between w-full px-3 py-2 text-left text-sm  transition-colors hover:cursor-pointer ${
                  isActive
    ...
    <div className="fixed left-1/2 -translate-x-1/2 bg-[#F5F5F5] dark:bg-[#1C1C1C] border border-gray-200 dark:border-neutral-800 rounded-lg shadow-lg p-1 flex gap-1 z-50 overflow-x-auto max-w-[95vw] items-center top-auto bottom-4 sm:top-4 sm:bottom-auto">
        ...
        {tools.map((tool) => {
          ...
          return (
            <button
              ...
              className={`relative p-2 rounded-md transition-colors shrink-0 hover:cursor-pointer ${
                activeTool === tool.id &&
                !tool.isAction &&
      ...
      <div className="flex md:hidden gap-1 items-center">
        ...
        {tools.slice(0, 2).map((tool) => (
          <button
            key={tool.id}
            onClick={() => handleClick(tool.id)}
            className={`p-2 rounded-md transition-colors shrink-0 hover:cursor-pointer ${
        ...
        <button
          ...
          className={`p-2 rounded-md transition-colors flex items-center gap-1 hover:cursor-pointer ${
      ...
      <div className="flex gap-1 border-l border-gray-200 dark:border-neutral-700 pl-1 ml-1 items-center">
        ...
        <button
          ...
          className="hidden md:flex p-2 rounded-md transition-colors text-gray-600 dark:text-neutral-400 hover:bg-gray-100 dark:hover:bg-neutral-800 hover:cursor-pointer"
          title={
            resolvedTheme === "dark"
              ? "Light mode - Ctrl+L"
              : "Dark mode - Ctrl+D"
